...
// This class implements substraction
class SubtractEquation final: public EquationBase
{
public:
    ...
    // It will accept no arguments. The right number   *
    // will be subtracted from the left number and the *
